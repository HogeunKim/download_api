...
REM Usage:
REM   make_docker_go_server_win.bat [VERSION] [IMAGE_NAME] [PLATFORM]
REM Example:
REM   make_docker_go_server_win.bat 1.0.1 go-api-server linux/amd64
...
if "%VERSION%"=="" (
  ...
  echo         Please pass version explicitly. Example: make_docker_go_server_win.bat 1.0.1
  exit /b 1
)
...
echo ========================================
echo Docker export batch (Windows) - GO server
